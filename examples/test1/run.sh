...
cmd="time python ../../src/drivers/driver.py -c 0 -n a,b,c --EOT 4 -f ./test1.ded --evaluator c4"
#cmd="time python ../../src/drivers/driver.py -n a,b,c --EOT 4 -f ./test1.ded --evaluator c4"
opt_cmd="cmd"
