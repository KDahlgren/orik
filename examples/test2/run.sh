...
cmd="time python ../../src/drivers/orik.py -c 0 -n a,b,c --EOT 4 -f ./test2.ded --evaluator c4"
#cmd="time python ../../src/drivers/orik.py -n a,b,c --EOT 4 -f ./test2.ded --evaluator c4"
opt_cmd="cmd"
